...
<section class="section" id="explore">
  <div class="section-inner">
    ...
    <p class="section-lede reveal">Four pages, each going deep on one part of the business \u2014 no padding, just the real material.</p>
...
<section class="section" style="padding-top:90px;">
  <div class="section-inner">
    ...
    <a href="assets/credentials/resume-taiyon-davis.pdf" target="_blank" rel="noopener" class="link-arrow reveal">
      View full resume PDF <svg width="12" height="12" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </a>
  </div>
</section>
...
<section class="section" style="border-top:1px solid var(--line);">
  <div class="section-inner about-grid">
    <div class="about-copy">
      <p class="eyebrow reveal">Education</p>
      <h2 class="section-title reveal">Formal education<br><em>and certification path.</em></h2>
    </div>
    <div class="reveal">
      <div class="spec-panel">
        <div class="spec-row"><span class="spec-label">University of Houston</span><span class="spec-value">2 semesters, no degree</span></div>
        <div class="spec-row"><span class="spec-label">Grand Oaks High School</span><span class="spec-value">Diploma</span></div>
        <div class="spec-row"><span class="spec-label">Full certifications</span><span class="spec-value"><a href="credentials.html" class="link-arrow" style="font-size:14px;">View credentials page</a></span></div>
      </div>
    </div>
  </div>
</section>
